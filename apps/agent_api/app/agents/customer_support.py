...
from apps.agent_api.app.database.models import ExecutionFailureEvidence, ProtocolCaseFacts, ProtocolStatusFacts
...
REQUEST_CREATED_AT. Choose LAST_EXECUTION_AT only when the user explicitly asks
which protocol executed/ran most recently or asks for the most recent executions.
...
sufficient. Return JSON with intent, protocol_number, run_id, limit,
evidence_needs, and discovery_order."""
        if already_loaded:
