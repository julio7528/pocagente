    ...
    async def validate() -> None:
        ...
        try:
            ...
            async with database.connection() as conn:
                ...
                lex_results = await repo.search_lexical_candidates(token_v1, 10)
                ...
                sem_results = await repo.search_semantic_candidates(
                    np.array(query_emb, dtype=np.float32), 10
                )
            ...
            async with database.connection() as conn:
                ...
                lex_v2 = await repo.search_lexical_candidates(token_v2, 10)
                assert len(lex_v2) >= 1
    ...
    async def validate() -> None:
        ...
        try:
            ...
            async with database.connection() as conn:
                ...
                lex = await repo.search_lexical_candidates(token_v1, 5)
                assert len(lex) >= 1
    ...
    async def validate() -> None:
        ...
        try:
            ...
            async with database.connection() as conn:
                ...
                lex_v1 = await repo.search_lexical_candidates(token_v1, 5)
                assert len(lex_v1) >= 1
            ...
            async with database.connection() as conn:
                ...
                lex_after = await repo.search_lexical_candidates(token_v1, 5)
                assert len(lex_after) >= 1
                assert lex_after[0].chunk.document_id == doc_after.document_id

                # - V2 content was never committed
                lex_v2 = await repo.search_lexical_candidates(token_v2, 5)
                assert len(lex_v2) == 0
